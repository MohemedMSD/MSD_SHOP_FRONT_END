...
const Visites = () => {
    ...
    const DisplayBy = async (date) => {
      ...
      try {
        ...
        const res = await Axios.get(`/statistic/visites/${date}`)
...
;
  ...
  return (
    ...
    <div className='h-full relative'>
      ...
      <h2 className=' text-primary_text mb-3 font-bold text-center text-[20px] md:text-[22px] lg:text-[23px] xl:text-[25px]'>Visitors</h2>
